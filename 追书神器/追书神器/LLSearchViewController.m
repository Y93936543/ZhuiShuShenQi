...
{
    if (!_hotArray) {
        self.hotArray = [NSMutableArray arrayWithObjects:@"系统", @"重生", @"快穿", @"都市", @"三国", @"圣墟", @"斗破苍穹", @"火影",@"空间",@"末世",@"洪荒",@"海贼", nil];
    }
    return _hotArray;
}
...
- (void)setBarButtonItem
{
    ...
    searchBar.placeholder = @"请输入书名或作者名";
    searchBar.backgroundImage = [UIImage imageNamed:@"clearImage"];
    searchBar.delegate = self;
    searchBar.showsCancelButton = YES;
    UIView *searchTextField = searchTextField = [searchBar valueForKey:@"_searchField"];
    searchTextField.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1];
