...
- (UIView *)setViewWithOriginY:(CGFloat)riginY title:(NSString *)title textArr:(NSMutableArray *)textArr
{
    ...
    for (int i = 0; i < textArr.count; i++) {
        ...
        if (i % 2 == 0 && [title isEqualToString:@"热门搜索"]) {
            label.layer.borderColor = [UIColor colorWithHex:0xFF9499].CGColor;
            label.textColor = [UIColor colorWithHex:0xFF9499];
        } else {
            label.textColor = [UIColor colorWithHex:0x6F6F6F];
            label.layer.borderColor = [UIColor colorWithHex:0xE3E3E3].CGColor;
        }
